...
function checkBoard() {
  ...
  // now take the 4 vales in each winningArray and plug them into the squars
    ...
    //   now check if they all have the class of player two
    else if (
...
// add an eventListener to each square that will trigger the checkboard function
